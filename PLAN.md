...
- [ ] 5.3 **Buscador global**: búsqueda de texto (título + `contentText`, full-text de Postgres) combinable con **filtrado por tags** (incluye el `?tagIds=` de la API, que la 5.1 dejó fuera a propósito).
