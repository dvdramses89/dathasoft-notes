...
- [~] 6.1 **Favoritos**: modelo `Favorite` + API + sección "Favoritos" en el sidebar. *(Partida en API y web, igual que la Fase 5.)*
  ...
  - [ ] 6.1.b **Web**: estrella para marcar/desmarcar y sección «Favoritos» en el sidebar.
