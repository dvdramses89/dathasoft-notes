...
- [ ] 5.2 Web: asignar tags a documentos y filtrar por tags. *(Incluye añadir `tags` a los tipos `DocumentFull`/`DocumentListItem` de `apps/web/src/lib/api.ts`, que hoy no lo declaran aunque la API ya lo devuelva.)*
